      ...
      className="flex w-full flex-col lg:flex-row items-center gap-20 my-20 ">
       ...
       transition={{duration:0.8, delay:0.6}} className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            Beginner Full-Stack Web Developer with experience building
            responsive and dynamic web applications. Skilled in both frontend
            and backend development, working with modern web technologies and
            databases. Passionate about learning, solving problems, and creating
       ...
       transition={{duration:0.8, delay:1}}
          className="grid grid-clos-1 sm:grid-cols-3 gap-6 max-w-2xl">
